...
It is saved in the subfolder  **rawDataDir**  of the current
...
```{r GOAnalysisCreateBackgrounds, eval=TRUE, warning=FALSE, message=FALSE, dependson="excludeMultipleMappings"}
