...
## trigger garbage collection after each evaluated code chunk to improve build
## stability by reducing the chance on running out of memory
knit_hooks$set(eval = function(before, options) {
  if ( !isTRUE(before) && isTRUE(options$eval) )
    gc()
})
```
