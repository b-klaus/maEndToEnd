...
message( paste0(c("number of C DE genes: ", table(tableC[,"adj.P.Val"] < 0.05)[2], collapse = " ")))

DEgenesCD <- tableC[tableC[,"adj.P.Val"] < 0.05,]
...
backGIdx <- genefinder(PalmieriFinal, DEgenesCD , 
