...
```{r GOAnalysisCreateBackgrounds, eval=TRUE, dependson=c("extractResults", "excludeMultipleMappings"), warning=FALSE}
...
backGIdx <- genefinder(PalmieriFinal, c("8121563", "8125048"), 1, 
