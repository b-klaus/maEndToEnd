...
Then we create a factors <!-- SR: what are a factors? --> that give us the grouping for the diseases and
...
In the acutal modell fitting every "1" in the model matrix corresponds to
...
We will compare the actual gene expression to the model fitts for a single
gene below.
