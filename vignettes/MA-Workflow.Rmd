...
#SR: muss man disease und tissue nicht noch als factor umwandeln? also z.B.
#disease <- factor(disease) -> wahrscheinlich nicht, weil die Werte nicht numerisch sind --> R merkt dann automatisch, dass das Faktoren sind, oder? 
...
Thus, we create a contrast matrix consisting of one row. <!-- SR: view contrast matrix contrast_matrix_CD; it has three columns and many rows, so maybe reformulate this part? -->  `r Biocpkg("limma")` 's function
...
disease and 0.02 <!-- SR: aus den Paper results tables, die FDR Werte; wir benutzen einheitlichen FDR von 0.05, weil das sinnvoller ist --> in ulcerative colitis. There are four tables in total giving
