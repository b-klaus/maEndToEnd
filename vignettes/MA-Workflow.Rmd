...
top_GO_data <- new("topGOdata", ontology = ont, allGenes = all_genes,
 nodeSize = 10, annot=annFUN.db, affyLib = "hugene10sttranscriptcluster.db") #SR: https://bioconductor.org/packages/release/bioc/vignettes/topGO/inst/doc/topGO.pdf is an instruction on how to use topGOdata, and it says that the argument for ontology should be "BP, MF or CC" -> what is ont then? 
```
...
#bedeutet raw p-value == 2, dass das die Gruppe der p-values ist, die signifikant sind? 
...
<!-- SR: why do we take Fisher classic here for the three most significant nodes? -->
...
entrez_ids <- mapIds(hugene10sttranscriptcluster.db, 
      ...
      keytype="PROBEID",
      column = "ENTREZID")
#SR: discuss: what das keytype = "PROBEID" do? 
```
...
<!--SR: discuss with Bernd: what was it that you wanted to implement right in the beginning and we took it out because the max amount of TLLs was reached? It had to do with reactome and enrichment analysis, right? -->
