...
```{r VolcanoPlot, fig.cap="Volcano plot of the DE-genes", fig.height=4, fig.width=3.5}
...
We can now research on the biological function of genes that show a  high fold
change, for example the gene with the symbol S100A8 on the right side of the
plot (Figure \@ref(fig:VolcanoPlot)). If we search for this gene symbol on
