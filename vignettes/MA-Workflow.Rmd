...
if (!on.bioc) {
  knitr::opts_chunk$set(fig.path = "", out.width="250px")
} 
...
install_github("Steffireise/maEndToEnd", ref="master")
...
ggplot2::ggplot
(RLE_data_gathered, aes(patient_probe, log2_expression_variation)) + 
...
tissue <- 
  str_replace_all
(Biobase::pData(palmieri_final)$Factor.Value.phenotype., " ", "_")
tissue <- 
