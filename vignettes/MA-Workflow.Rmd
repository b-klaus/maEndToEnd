...
We will compare the actual gene expression to the model fits for a single
gene below.
...
<!-- SR: what exactly would be the linear model for this gene? explain this in more detail! --> 
We choose the 
 **CRAT** gene (probe ID 8164535) in CD. The first plot we prodcue is a scatterplot that compares
...
#SR: discuss whether this can be called fold-change or shouldn't rather be described as a difference --> https://en.wikipedia.org/wiki/Fold_change
