...
RLE_data_subset <- (RLE_data[sample(nrow(RLE_data), 50),])
...
ggplot(RLE_data_subset_trafo.m, aes (group, value)) + geom_boxplot() + geom_jitter (width = 0.5)#--> schöne Idee, aber der melting Schritt benötigt viel zu viel Rechenleistung
...
RLE_data_subset_trafo$group <- rownames(RLE_data_subset_trafo)
RLE_data_subset_trafo.m <- melt(RLE_data_subset_trafo, id.vars= "group")
ggplot(RLE_data_subset_trafo.m, aes (group, value)) + geom_boxplot(outlier.size=0.2)
