...
When we are content with the manual threshold, we filter out all transcripts 
that don't have intensities greater than the threshold in at least 
as many arrays as the smallest experimental group (4 `r min(no_of_samples)`,) which we 
