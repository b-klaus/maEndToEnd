...
We illustrate use the linear models fitted using the **CRAT** gene (probe ID 
8164535) in CD. The first plot we prodcue is a scatterplot that compares
the fitted (as returned by the linear model) to the actual values.

The fitted values are obtained 
...
We see that the actuall expression values are reasonably similar to
...
Ther is substantial between-subject variation here, as indicated
