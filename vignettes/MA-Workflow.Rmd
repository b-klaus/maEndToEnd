...
```
On the heatmap plot (Figure \@ref(fig:HeatmapWithAnnotation)) we also see that the samples do not cluster strongly by tissue, confirming the impression from the PCA plot
...
to outliers that could potentially be removed: the ones that could be flagged here are 2826_II, 3262_II, 3271_I, 2978_II and 3332_II. 
