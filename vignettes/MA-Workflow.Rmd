...
<!--
     ...
     #SR: this does not work for me, I won't find BiocStyle and knitr 
-->
...
but can easily be adapted to  similar platforms.
...
```{r rownames for heatmap, fig.height = 8.5, eval = TRUE, echo=FALSE}
phenotype_names <- c()
disease_names <- c()
...
```{r clustering heatmap, fig.height = 8.5, eval = TRUE }
...
```{r filtering_of_low_intensity_transcripts}
