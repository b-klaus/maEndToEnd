...
The `maEndToEnd` package can currently be obtained from GitHub and has been
submitted to Bioconductor (see here: <https://github.com/Bioconductor/Contributions/issues/765>).

## Workflow package installation from Bioconductor

Once the workflow packages has been published on Bioconductor,
you will simply be able install it via the `biocLite` function.
