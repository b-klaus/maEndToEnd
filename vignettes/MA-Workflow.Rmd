...
#    filter(no_of_matches > 1)
```
#getting the output of the %>%-function with the affycoretools package
...
probe_stats1 <- anno_palmieri
probe_stats2 <- probe_stats1[!duplicated(probe_stats1[,1]),] #doesn't work, because duplicated stops after 1875; why is that?

no_of_multiple_assigned <- n_distinct(probe_stats1$SYMBOL)-n_distinct(probe_stats2$SYMBOL)

```

#Code Bernd (18.04.): mit Annotate_eset-funktion aus affycoretools
