...
"Gene" arrays were created as affordable versions of the "Exon" arrays, by only taking the "good" probes from the Exon array. Initially on the Exon array, at least four probes were part of one "Exon". With the thinned out "Gene" array, many probesets were made up of three or fewer probes: 

```{r DifferenceBetweenExonAndGeneTypeArrays, fig.width=7, fig.height=6, echo=FALSE}
par(mar=c(0,0,0,0))
...
Thus, a summarization on the probeset / exon level 
