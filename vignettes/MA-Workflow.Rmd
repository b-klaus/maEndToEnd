...
polygon(c(50,85,85,50),c(70,70,130,130),col=rgb(1,0,0,.5),border=NA)
...
polygon(c(45,49,49,45),c(70,70,130,130),col=rgb(0,.7,.5,1),border=NA)
text(47,100, "microarray probes", srt=90, cex=1)

polygon(c(50,85,85,50),c(131,131,140,140),col=rgb(.8,.2,.5),border=NA)
...
polygon(c(15,19,19,15),c(70,70,130,130),col=rgb(0,.7,.5,1),border=NA)
text(17,100, "microarray probes", srt=90, cex=1)

polygon(c(20,40,40,20),c(131,131,140,140),col=rgb(0,.5,.7),border=NA)
...
polygon(c(50,65, 65, 50),c(56,56,65,65),col=rgb(.8,.2,.5),border=NA)
