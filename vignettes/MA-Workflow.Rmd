...
The maEndToEnd package can currently be loaded from GitHub and will be on the next release of Bioconductor. 
...
library(remotes)
packageVersion("remotes") #has to be 1.1.1.9000 or above
