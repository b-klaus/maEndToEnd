...
```{r clusteringHeatmap, fig.height = 8.5, eval = TRUE }
...
```{r alternativeIntensityBasedFilteringManuallyFiltered}
...
```{r  graphOfResults, fig.height = 6, eval=TRUE, results='hide'}
...
```{r runReactomeEnrichment, eval = TRUE}
