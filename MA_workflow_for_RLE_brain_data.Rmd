...
Note in the next step, that we only import the 27 files mentioned in the paper, that is the ones analyzed with the A↵ymetrix HG-U95A microarray, as opposed to the other ones analyzed with a "v2" of the same array.
